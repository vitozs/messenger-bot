...
public class SendMessageToUserService {
    ...
    private final BotResponseBuilderService botResponseBuilderService;
    public SendMessageToUserService(){
        botResponseBuilderService = new BotResponseBuilderService();
    }
